...
export const CommentComponent = ({comment}) => {
  // JS
  const urlDelete = "http://ec2-52-200-109-82.compute-1.amazonaws.com/testFinalProjects/new/actions/deleteData/deleteComment.php";
  ...
  return (
    <div className="comentario mb-3" id={comment.CommentId}>
      ...
      <p className="text-end mb-2">
        {checkComment()} {returnDate(comment.CommentDate)} | <a href={'/user?username='+comment.CommentUsername}>{comment.CommentUsername}</a>
      </p>
    </div>
  );
};
