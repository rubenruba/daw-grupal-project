...
export const Favorites = (prop) => {
  // JS
  const urlAllPosts =
    "http://ec2-35-168-11-113.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/getAllPost.php";
  const urlSearch =
    "http://ec2-35-168-11-113.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/searchPost.php";
  const urlFav =
    "http://ec2-35-168-11-113.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/getAllFavPosts.php";
