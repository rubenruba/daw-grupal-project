...
export const CreatePostPage = () => {
    ...
    const urlPost = 'http://ec2-34-207-224-244.compute-1.amazonaws.com/backend/actions/createData/createPost.php';
    const urlLabel = 'http://ec2-34-207-224-244.compute-1.amazonaws.com/backend/actions/readData/getAllLabels.php';
