...
export const CreatePostPage = () => {
    ...
    const urlPost = 'http://ec2-3-86-101-85.compute-1.amazonaws.com/testFinalProjects/new/actions/createData/createPost.php';
    const urlLabel = 'http://ec2-3-86-101-85.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/getAllLabels.php';
