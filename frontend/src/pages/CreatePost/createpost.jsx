        ...
        const Publica = async () => {
            ...
            try {
                let palabrasInapropiadas = [
                    ...
                    "putero", "puti", "puto", "tupu","follar","folla"
                ];            
                ...
                arr.forEach(element => {
                    if(palabrasInapropiadas.includes(element.toLowerCase())){
                        ...
                        alerta.textContent="Tu POST no se ha enviado por cumplimiento de lenguaje ofensivo";
                ...
                //SINO HA CUMPLIDO NINGUNA DE LAS DOS CONDICIONES PASADAS QUE LO ENVIE
            } catch (error) {
                console.error(error);
            }
        };
            ...
            <>
                ...
                <section className='create-post-container pt-5 pb-5'>
                    <form action="" id='formularioapi' onSubmit={(e) => corta(e)}>
                        ...
                        <div id='alert' className='d-flex justify-content-center mt-4 text-danger ms-3 p-3'>
                        </div>
