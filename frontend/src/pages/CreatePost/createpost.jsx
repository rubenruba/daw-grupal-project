...
export const CreatePostPage = () => {
    ...
    const urlPost = 'http://ec2-52-200-109-82.compute-1.amazonaws.com/testFinalProjects/new/actions/createData/createPost.php';
    const urlLabel = 'http://ec2-52-200-109-82.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/getAllLabels.php';
