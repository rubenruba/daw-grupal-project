...
export const CreatePostPage = () => {
    ...
    const urlPost = 'http://ec2-18-234-198-232.compute-1.amazonaws.com/testFinalProjects/new/actions/createData/createPost.php';
    const urlLabel = 'http://ec2-18-234-198-232.compute-1.amazonaws.com/testFinalProjects/new/actions/readData/getAllLabels.php';
